...
from web3_wizzard_lib.core.sybil_engine.domain.balance.balance import NotEnoughNativeBalance, Erc20Balance, WETHBalance, NativeBalance
from web3_wizzard_lib.core.sybil_engine.utils.utils import interval_to_round, ConfigurationException
...
def interval_to_weth_balance(erc20_interval, account, chain, web3):
    from web3_wizzard_lib.core.sybil_engine.domain.balance.tokens import WETHToken
